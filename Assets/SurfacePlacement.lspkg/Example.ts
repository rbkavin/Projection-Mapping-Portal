...
import { ProjectionMappingController } from "../Scripts/ProjectionMappingController";
...
export class Example extends BaseScriptComponent {
  ...
  @ui.separator
  @ui.label('<span style="color: #60A5FA;">Portal Calibration</span>')
  @ui.label('<span style="color: #94A3B8; font-size: 11px;">Wire the ProjectionMappingController scene object here</span>')

  @input
  @allowUndefined
  @hint("ProjectionMappingController scene object — auto-calibrates when surface is placed")
  projectionController: ProjectionMappingController;
  ...
  resetPlacement() {
    ...
    this.projectionController?.onPlacementReset();
    this.startPlacement();
  }
  ...
  private onSurfaceDetected(pos: vec3, rot: quat) {
    ...
    this.projectionController?.onPortalPlaced();
  }
}
